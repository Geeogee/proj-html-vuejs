...
var _require = __webpack_require__(/*! @babel/types */ "./node_modules/@babel/types/lib/index.js"),
    tsMethodSignature = _require.tsMethodSignature;
  ...
  new Vue({
    ...
    data: {
      ...
      "allPosts": [{
        ...
        "id": "allpost4",
        "imgType": "gallery",
        "img": ["img/blog-13.jpg", "img/blog-16.jpg", "img/blog-20.jpg", "img/blog-23.jpg", "img/blog-29.jpg", "img/blog-40.jpg"],
    ...
    methods: {
      ...
      openLightbox: function openLightbox(image, index, gallery) {
      ...
      prevLightbox: function prevLightbox() {
        var max = this.activeGallery.length - 1;
        this.activeIndex--;
